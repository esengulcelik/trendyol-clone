  ...
  return (
    <>
      <div className="container mx-auto max-w-7xl mb-10">
        <div className="relative bg-gradient-to-b from-gri to-white w-full py-6 rounded-lg px-4">
          <div className="flex justify-between pb-3">
            ...
            <div className="flex gap-2 items-center">
              <p className="text-black text-xl font-semibold">Tüm Ürünler</p>
